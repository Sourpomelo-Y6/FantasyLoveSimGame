...
- 予定パネルの週間・月間カレンダーから、今後30日分の予定を確認・設定・キャンセルできる
- 7日／30日の予定テンプレートを複数保存し、別のゲームセーブからも利用できる
...
- 予定を選ぶと予定パネルが開き、週間・月間表示から日付を選んで予定を設定する
- 設定済みで未実行の予定は選択日の詳細欄からキャンセルできる
- よく使う予定の並びはテンプレートとして保存・適用できる
- 予定パネルは戻るボタンで閉じる
...
- [`Assets/Images/Heroines/DefaultHeroine/Sprites/`](Assets/Images/Heroines/DefaultHeroine/Sprites): 現在ヒロインの立ち絵
- [`Assets/Images/Heroines/DefaultHeroine/`](Assets/Images/Heroines/DefaultHeroine): 現在ヒロインの立ち絵・行動・イベント・エンディング画像
