...
public class ScheduleManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Debug.Log("ç°ì˙ÇÃó\íËÅF" + GetTodayScheduleDisplayName());
            Debug.Log("ñæì˙ÇÃó\íËÅF" + GetTomorrowScheduleDisplayName());
        }
    ...
    public void SetTomorrowSchedule(ScheduleType scheduleType)
    {
        ...
        Debug.Log("ñæì˙ÇÃó\íËÇê›íËÇµÇ‹ÇµÇΩÅF" + GetScheduleDisplayName(tomorrowSchedule));
    }
    ...
    public void AdvanceScheduleToToday()
    {
        ...
        Debug.Log("ç°ì˙ÇÃó\íËÅF" + GetScheduleDisplayName(todaySchedule));
    }
