...
Importer は `HeroineImportReport` で copied images、catalog assets、layers、conversations、game events、action reactions、endings、warning 件数を集計し、完了時に Console summary と `EditorUtility.DisplayDialog` で結果を表示する。
